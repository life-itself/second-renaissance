          ...
          return (
            <div key={org.id} className="group relative">
              <div className="w-full min-h-80 bg-beige aspect-w-1 aspect-h-1 rounded-md overflow-hidden group-hover:opacity-75 lg:h-80 lg:aspect-none">
                <img
                  src={
                    (org.logo.cached_new || org.logo.url) ??
                    (org.image.cached_new || org.image.url)
                  }
                  alt={org.title}
              ...
              <div className="mt-2 flex justify-between">
                <div>
                  <a className="extra-small exception font-medium tracking-wide text-accent uppercase">
                    {org.category}
                  </a>
