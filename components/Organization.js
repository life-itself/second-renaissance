    ...
    <div className="bg-white">
      <div className="max-w-2xl mx-auto pb-16 pt-10 px-4 sm:pb-24 sm:px-6 lg:max-w-7xl lg:px-8 lg:grid lg:grid-cols-2 lg:gap-x-8">
        ...
        <div className="lg:max-w-lg lg:self-end">
          <div className="mt-4">
            <h1 className="text-3xl font-extrabold tracking-tight text-gray-900 sm:text-4xl">{org.title}</h1>
        ...
        <div className="flex flex-col">
          <div className="flex flex-row">
            ...
            <p className="mt-6 ml-2 text-sm text-gray-500">{org.locations}</p>
          </div>
          <div className="flex flex-row">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mt-2" fill="none" viewBox="0 0 24 24" stroke="darkgray">
            ...
            <p className="mt-2 ml-2 text-sm text-gray-500">{org.activity}, {org.activity_2}</p>
          </div>
          <div className="flex flex-row">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mt-2" fill="none" viewBox="0 0 24 24" stroke="darkgray">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 20l4-16m2 16l4-16M6 9h14M4 15h14" />
          </svg>
            <p className="mt-2 ml-2 text-sm text-gray-500">{org.topic}, {org.topic_2}</p>
          </div>
        </div>
