		...
		<div className="-mx-[max(calc(50vw-44rem+4rem),4rem)] md:-mx-[max(calc(50vw-44rem+8rem),8rem)] lg:-mx-[max(calc(50vw-44rem+18rem),18rem)] -mt-8 relative bg-gray-50 overflow-hidden">
			...
			<div className="relative pt-6 pb-16 sm:pb-24">
				<main className="mt-16 mx-auto max-w-7xl px-4 sm:mt-24">
					<div className="text-center">
						<h1 className="flex flex-col gap-y-2 h-48 min-[391px]:h-32 sm:h-48 lg:h-32 text-4xl tracking-tight font-extrabold text-primary sm:text-5xl md:text-6xl">
							<span>"PIP" Pioneers: Mapping an Emerging Ecosystem for Deep-rooted Social Change</span>
              <span ref={el} className="mx-auto w-fit sm:w-auto flex sm:inline" />
						...
						An emerging ecosystem is developing radical, alternative approaches to social change. What unites them is that they are simultaneously paradigmatic, integrative, and pragmatic (PIP). This page provides an introduction to the ecosystem's key features and ideas – and offers a directory and visual maps of organizations and initiatives.
						</p>
						<div className="mt-5 max-w-md mx-auto sm:flex sm:justify-center md:mt-8">
							<div className="rounded-md shadow">
								...
								>
									Discover what makes this ecosystem unique
								</a>
							</div>
							<div className="mt-3 rounded-md shadow sm:mt-0 sm:ml-3">
								...
								<a href="#profiles" className="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-indigo-600 bg-gray-100 hover:bg-gray-200 md:py-4 md:text-lg md:px-10">
									Explore organizations who are part of it
								</a>
								{/* </Link> */}
							</div>
							<div className="mt-3 rounded-md shadow sm:mt-0 sm:ml-3">
